...
void CScene_Tool::SaveTileData()
{
	...
	ofn.hwndOwner = CCore::GetInst()->GetMainHwnd();//열릴 상위 윈도우
	ofn.lpstrFile = szName; //저장할 최종 경로
	ofn.nMaxFile = sizeof(szName);//경로의 크기
	ofn.lpstrFilter = L"ALL\0*.*\0Tile\0*.tile\0";	//특정파일만 보여주게 하는 필터
	ofn.nFilterIndex = 0;//필터에서 기본선택 뭘로 되어있냐
	ofn.lpstrFileTitle = nullptr;//창의 제목
	ofn.nMaxFileTitle = 0;
	...
	ofn.Flags = OFN_PATHMUSTEXIST | OFN_FILEMUSTEXIST;//경로와 파일이 반드시 존재해야 한다.
